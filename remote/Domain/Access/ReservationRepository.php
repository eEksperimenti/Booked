...
class ReservationRepository implements IReservationRepository
{
	...
	private function InsertSeries(ReservationSeries $reservationSeries)
	{
		...
		$insertReservationSeries->addParameter(new Parameter("@experiment",$reservationSeries->experiment()));
...
class InstanceAddedEventCommand extends EventCommand
{
	...
	public function Execute(Database $database)
	{
		$insertReservation = new AddReservationCommand($this->instance->StartDate(), $this->instance->EndDate(), $this->instance->ReferenceNumber(), $this->series->SeriesId(),$this->instance->experiment);
