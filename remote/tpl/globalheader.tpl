		...
		<div id="header">
			<div>
				...
				<li class="logo first "style="width:250px">
						<a href="{$HomeUrl}" >{html_image src="$LogoUrl"}</a>
				</li>
			{if $LoggedIn}
				<li class="menubaritem"><a href="{$Path}{Pages::DASHBOARD}">{translate key="Dashboard"}</a></li>
				
				<li class="menubaritem"><a  class="nekej" id="dropLink"class="dropdown-toggle"  aria-haspopup="true" aria-expanded="true" data-toggle="dropdown" href="{$Path}{Pages::SCHEDULE}">{translate key="Schedule"}</a>
			...
			{if $CanViewAdmin}
				<li class="menubaritem"><a class="nekej" href="#">{translate key=ApplicationManagement}</a>
					<ul id="subNav">
						<li class="menuitem"><a
			...
			{if $CanViewResponsibilities}
				<li class="menubaritem"><a  class="nekej" href="#">{translate key=Responsibilities}</a>
					<ul id="subNav">
			...
			{/if}
			{if $CanViewReports}
			<li class="menubaritem"><a class="nekej" href="{$Path}reports/{Pages::REPORTS_GENERATE}">{translate key=Reports}</a>
				<ul id="subNav">
			...
			{/if}
			{/if}
				<li class="menubaritem"><a class="nekej" href="{$Path}help.php">{translate key=Help}</a>
					<ul id="subNav">
