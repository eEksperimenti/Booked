...
Modifications: line 2019 is commented out (do not store passwords in the database, since Shibboleth is used for user authentication)
...
class UpdateUserCommand extends SqlCommand
{
		...
		$scheduleId)
	{
		...
		$this->AddParameter(new Parameter(ParameterNames::USER_ID, $userId));
		$this->AddParameter(new Parameter(ParameterNames::USER_STATUS_ID, $statusId));
// do not store passwords! $this->AddParameter(new Parameter(ParameterNames::PASSWORD, $encryptedPassword));
