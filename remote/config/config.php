<?php
/**
Modified by Alenka Kavèiè (alenka.kavcic@fri.uni-lj.si), UL FRI, December 2015
Configuration adapted to the served for eExperiments
 ...
 */
$conf['settings']['app.title'] = 'eEksperimenti - sistem za rezervacije';			// application title
$conf['settings']['default.timezone'] = 'Europe/Ljubljana';      // look up here http://php.net/manual/en/timezones.php
$conf['settings']['allow.self.registration'] = 'false';         	// if users can register themselves
$conf['settings']['admin.email'] = 'admin@eeksperimenti.si';         // email address of admin user - VPIŠI DEJANSKEGA ADMINISTRATORJA
$conf['settings']['admin.email.name'] = 'eEksperimenti administrator';	// name to be used in From: field when sending automatic emails
...
$conf['settings']['default.language'] = 'si_si';                // find your language in the lang directory
$conf['settings']['script.url'] = 'https://eeksperimenti.si/Web';   	// public URL to the Web directory of this instance. this is the URL that appears when you are logging in. leave http: or https: off to auto-detect
...
$conf['settings']['logout.url'] = 'https://eeksperimenti.si/Shibboleth.sso/Logout'; 	      					// the url to be directed to after logging out
...
$conf['settings']['database']['user'] = 'UPORABNIK';        // database user with permission to the booked database
$conf['settings']['database']['password'] = 'GESLO';
$conf['settings']['database']['hostspec'] = 'localhost';        // ip, dns or named pipe
$conf['settings']['database']['name'] = 'eeksperimenti_bs';
/**
 ...
 */
$conf['settings']['plugins']['Authentication'] = 'Shibboleth';
 ...
 */
$conf['settings']['install.password'] = 'GESLO_ZA_NAMESTITEV';
/**
 * Pages
 */
